...
class DQN:
    ...
    def _calculate_loss(self, minibatch):
        ...
        nextstate_q_values_target = self.target_network.forward(minibatch_nextstates_tensor).detach()
        #nextstate_q_values_target = nextstate_q_values_target.detach()
...
if __name__ == "__main__":
    ...
    for epoch in range(100):
        ...
        average_loss = np.average(step_losses)
